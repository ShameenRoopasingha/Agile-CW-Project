...
import { getAllRoutesForWeek, generateWeeklyRoutes, deleteAllRoutesForWeek, getAllRoutePlans, getRoutesForPlan, getSingleRoute, getRouteCollectionPoints, randomlyAssignTrucks, manuallyAssignTruck, unassignTruck, unassignAllTrucks, getAvailableTrucks } from "../../lib/api";
...
export function RoutesOverview() {
  ...
  const [collectionPoints, setCollectionPoints] = useState<[number, number][]>([]);
